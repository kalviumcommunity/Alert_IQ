...
- **Feature Branches**:
  ...
  - **Branch Naming Pattern**: `[type]/[short-description]`
    - `feature/` - New features or capabilities (e.g., `feature/data-ingestion`, `feature/alert-routing`)
...
### PR Requirements
1. **Clear Title & Context**: Use descriptive PR titles (e.g., `feat: add data validation workflow and team branching guidelines`).
